...
var metrics		= null; //Die INfors über fonts
...
window['GLB_ON_LOOP'] = function() {
	DRAWLINE(10, 10, ((KERNLEN("0ööäää ii ß", 1)) + (10)), 10, RGB(0, 0, 255));
	PRINT("0ööäää ii ß", 10, 10, 1);
	PRINT(CAST2STRING(KERNLEN("6", 1)), 10, 140, 1);
	SHOWSCREEN();
