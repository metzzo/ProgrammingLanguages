...
window['main'] = function(){
	var local9_image_Str_1242 = "", local4_pixl_1244 = new GLBArray(), local1_w_ref_1245 = [0], local1_h_ref_1246 = [0];
	local9_image_Str_1242 = (((((((((((((((((((((((((("") + ("....****...."))) + ("..**++++**.."))) + (".*++++++++*."))) + ("*++++++++++*"))) + ("*++++++*+++*"))) + ("*++++++*+++*"))) + ("*+++++*++++*"))) + (".*++*+++++*."))) + ("..********.."))) + ("....####...."))) + ("....####...."))) + ("...######..."))) + (""));
	DIM(global10_colors_Str, [4], "");
	global10_colors_Str.arrAccess(0).values[tmpPositionCache] = ((".") + (CAST2STRING(INTEGER(0))));
	global10_colors_Str.arrAccess(1).values[tmpPositionCache] = (("+") + (CAST2STRING(INTEGER(-16711808))));
	global10_colors_Str.arrAccess(2).values[tmpPositionCache] = (("*") + (CAST2STRING(INTEGER(-16744448))));
	global10_colors_Str.arrAccess(3).values[tmpPositionCache] = (("#") + (CAST2STRING(INTEGER(-16744193))));
	func9_MakeImage(0, 12, local9_image_Str_1242, unref(global10_colors_Str));
	SPRITE2MEM(unref(local4_pixl_1244), 0);
	GETSPRITESIZE(0, local1_w_ref_1245, local1_h_ref_1246);
	MEM2SPRITE(unref(local4_pixl_1244), 1, unref(local1_w_ref_1245[0]), unref(local1_h_ref_1246[0]));
...
window['WaitMouse'] = WaitMouse;
window['func9_MakeImage'] = function(param3_num, param5_width, param9_image_Str, param10_colors_Str) {
	var local1_x_1251 = 0, local1_y_1252 = 0, local5_c_Str_1253 = "", local6_height_1254 = 0, local3_pix_1255 = new GLBArray();
	local6_height_1254 = CAST2INT((((param9_image_Str).length) / (param5_width)));
	DIM(local3_pix_1255, [((param5_width) * (local6_height_1254))], 0);
	{
		for (local1_y_1252 = 0;toCheck(local1_y_1252, ((local6_height_1254) - (1)), 1);local1_y_1252 += 1) {
			{
				for (local1_x_1251 = 0;toCheck(local1_x_1251, ((param5_width) - (1)), 1);local1_x_1251 += 1) {
					local5_c_Str_1253 = MID_Str(param9_image_Str, ((local1_x_1251) + (((local1_y_1252) * (param5_width)))), 1);
					{
						var local1_i_1256 = 0.0;
						for (local1_i_1256 = 0;toCheck(local1_i_1256, ((BOUNDS(param10_colors_Str, 0)) - (1)), 1);local1_i_1256 += 1) {
							if ((((local5_c_Str_1253) == (MID_Str(param10_colors_Str.arrAccess(~~(local1_i_1256)).values[tmpPositionCache], 0, 1))) ? 1 : 0)) {
								local3_pix_1255.arrAccess(((local1_x_1251) + (((local1_y_1252) * (param5_width))))).values[tmpPositionCache] = INT2STR(MID_Str(param10_colors_Str.arrAccess(~~(local1_i_1256)).values[tmpPositionCache], 1, 9));
								break;
	...
	MEM2SPRITE(unref(local3_pix_1255), param3_num, param5_width, local6_height_1254);
	return 0;
